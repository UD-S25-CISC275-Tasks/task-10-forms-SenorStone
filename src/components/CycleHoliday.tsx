...
export function CycleHoliday(): React.JSX.Element {
    ...
    function alphaSwap(): void {
        holiday === "Best Friend Day" ? setHoliday("Cheese Day")
        : holiday === "Cheese Day" ? setHoliday("Dog Day")
        : holiday === "Dog Day" ? setHoliday("Go Fishing Day")
        : holiday === "Go Fishing Day" ? setHoliday("World Parrot Day")
        : setHoliday("Best Friend Day");
    }

    function dateSwap(): void {
        holiday === "World Parrot Day" ? setHoliday("Cheese Day")
        : holiday === "Cheese Day" ? setHoliday("Best Friend Day")
        : holiday === "Best Friend Day" ? setHoliday("Go Fishing Day")
        : holiday === "Go Fishing Day" ? setHoliday("Dog Day")
